...
# For the given branch (or master), find all branches that have already been
# merged into it and delete them.
function delmerged() {
...
function cmake_rel() {
    cmake -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCUDA_BUILD=On -DCMAKE_VERBOSE_MAKEFILE=OFF ..
}
function cmake_deb() {
    cmake -DCMAKE_BUILD_TYPE=Debug -DCUDA_BUILD=On ..
}

function localpsql {
        PGHOST='127.0.0.1' PGDATABASE=test_copy psql $@
}

export PATH=$PATH:/home/beckvold/bin:/opt/riscv32i/bin
...
export MT_REGD_HOST=192.168.1.2
