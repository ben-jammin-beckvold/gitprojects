...
IMAGE_PIPELINE_DIR=~/pff-ros-ws/src/pff_third_party/core/image_pipeline/
touch ${IMAGE_PIPELINE_DIR}/image_pipeline/CATKIN_IGNORE
touch ${IMAGE_PIPELINE_DIR}/stereo_image_proc/CATKIN_IGNORE
