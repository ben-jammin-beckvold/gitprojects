...
#define I2C_ADDRESS 	0x77 << 1  // 7 bit address for IO_expander dev board
#define I2C_READ_BIT 	1
#define I2C_WRITE_BIT 	0

#define I2C_BUS_FREQ 	0x0080	// 223.2kHz

// launchpad test uses --- PB5 --- as the DFU_reset pin
#define DFU_TRIGGER_PIN     (1 << 7)  // toggles the DFU pin on the MCU
#define RESET_MCU_PIN       (1 << 6)  // reset pin on the MCU

/**
 ** Registers used for configuration, setting output levels, and reading input levels
 **/
#define  INPUT_PORT_0    0x00  // read inputs
#define  INPUT_PORT_1    0x01
#define OUTPUT_PORT_0    0x02  // control outputs, read current output levels
#define OUTPUT_PORT_1    0x03
#define    INV_PORT_0    0x04  // invert the configured polarity on a pin
#define    INV_PORT_1    0x05
#define CONFIG_PORT_0    0x06  // configure a pin as an input or output
